...
<script>
	$(document).ready(function() {
		$('#slider1').on('change', function(){
			$.ajax({url: "/web_project/Controller?link=living_room&action=update&s_id=" + <%=bean.getS_aid()%> + "&sensor=led&state=" + $('#slider1').val() , success: function(result){
		   //     alert(result);
		    }});
			
		});
		$('#slider2').on('change', function(){
			$.ajax({url: "/web_project/Controller?link=living_room&action=update&s_id=" + <%=bean.getS_aid()%> + "&sensor=curtain&state=" + $('#slider2').val() , success: function(result){
		        //$("#div1").html(result);
		    }});
...
<div data-role="page" id="home">
 ...
 <div data-role="content" data-theme="d" style="width:100%; height:130vh;">
...
<!-- 거실 -->
<div style="background:#fceda7; width:390px; height:250px; border:solid black 1px; position:relative; left:312px; top:-304px; text-align:center;">living room</div>
<!-- 작은 방 -->
