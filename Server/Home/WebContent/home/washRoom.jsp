...
<script>
	$(document).ready(function() {
		$('#slider1').on('change', function(){
			$.ajax({url: "/web_project/Controller?link=wash_room&action=update&s_id=" + <%=bean.getS_aid()%> + "&sensor=led&state=" + $('#slider1').val() , success: function(result){
		   //     alert(result);
		    }});
...
<!-- 화장실 -->
<div style="background:#fceda7; width:98px; height:195px; border:solid black 1px; position:relative; text-align:center; left:252px; top:-449px;">wash room</div>
<!-- 큰 방 -->
