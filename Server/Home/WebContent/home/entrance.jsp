...
<%
	...
	SensorBean sbean1 = (SensorBean)request.getAttribute("sensorBean1");
...
<script>
	$(document).ready(function() {
		$('#slider1').on('change', function(){
			$.ajax({url: "/web_project/Controller?link=entrance&action=update&s_id=" + <%=bean.getS_aid()%> + "&sensor=led&state=" + $('#slider1').val() , success: function(result){
		    }});
...
<div data-role="page" id="home">
 ...
 <div data-role="content" data-theme="d" style="width:100%; height:120vh;">
	...
	<div style="position:absolute;">
		...
		<!-- 현관 복도 -->
		<div style="background:#fceda7;width:350px; height:50px; border:solid black 1px; position:relative; left:0px; top:0px; text-align:center;">entrance</div>
		<!-- 거실 -->
